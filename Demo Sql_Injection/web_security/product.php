    ...
    if(isset($_POST['findproduct']))
    {
        ...
        if(!empty($price))
        {
            if(is_numeric($price)==1)
            {
                ...
                {
                    die("Price cannot contain characters <,',!,?,|>,");
                }
                ...
                die("Please enter price as number!");
            }
        }
        else
...
<body>
    ...
    <div class="input-group m-3">
        <input name="findproduct" id="findproduct" value="<?= $price ?>" type="number" class="form-control rounded" placeholder="Find products by price" aria-label="Search"
...
if(empty($price))
{
    ...
    echo '<h5  class="title">Products with prices below '.$price.'</h5>
    <table cellpadding="10" cellspacing="10" border="0" style="border-collapse: collapse; margin: auto">
    <tr class="header">
            <td>ID</td>
            <td>Image</td>
